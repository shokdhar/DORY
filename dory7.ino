...
//  }
  ...
  printOLEDMsg((char *)"Calibration", (char *)"Unused Strip", (char *)"and press button");
  ...
  printOLEDMsg((char *)"Exhale", (char *)"onto Strip", (char *)"on both sides");
  delay(5000);
