...
void computeTest(){
  ...
  int16_t specimen_diff = testStripReadings[AS726x_VIOLET]-dry_testStripReadings[AS726x_VIOLET];
  int16_t test_variance = (specimen_diff*1000.0)/(dry_testStripReadings[AS726x_VIOLET]*1.0);
  int16_t dry_diff = dry_controlStripReadings[AS726x_VIOLET] - controlStripReadings[AS726x_VIOLET];
  int16_t control_variance =  (dry_diff*1000.0)/dry_controlStripReadings[AS726x_VIOLET]*1.0;
  delay(100);
  ...
  if(testStripReadings[AS726x_VIOLET] < dry_testStripReadings[AS726x_VIOLET]*0.99){
...
*********************************************************************************************/
  ...
  if(dry_variance > 8){
    result = String("REPEAT TEST (ST ERR)");
    return;
  }
