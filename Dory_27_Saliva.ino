...
//////////// SETTINGS ////////////////////
float stain_margin_percent = 13;
float max_control_change_percent = 30;
int16_t max_negative_stain_margin_percent = 20;


uint16_t min_reading_threshold = 45;
//////////// END SETTINGS ////////////////
...
void computeTest() {
  ...
  //==========================================================================================
  if (control_variance > max_control_change_percent*10) {
    result = String("REPEAT TEST 3");
    oled.clearDisplay();
    oled.setCursor(5, 5);
    oled.setTextSize(2);
    oled.print("REPEAT TEST ");
    Serial.print("REPEAT TEST  max");
    delay(100);
    oled.display();
    return;
  }
  //==========================================================================================
  percent_variance = ((test_variance-control_variance)*100)/test_variance;
  Serial.println("percent_variance ");
  Serial.println(percent_variance );

  if (percent_variance > stain_margin_percent) {
